...
if show_images:
    ...
    plt.imshow(offset1ms[0], cmap='gray')
    plt.title('offset1ms (First frame)')
    plt.axis('off')
...
def sanuc(data1, data2):
    ...
    print(f"mu1 = {mu1.mean():.3f}, mu2 = {mu2.mean():.3f}")
    print(f"sigma1 = {sigma1.mean():.3f}, sigma2 = {sigma2.mean():.3f}")
...
K_nls = 300382277  # Placeholder value for K_nls, replace with actual calculation
